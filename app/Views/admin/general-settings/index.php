                    ...
                    <div class="card-body mx-5 my-3">
                        ...
                        <form action="<?= base_url('admin/general-settings/update'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" id="school_name" class="form-control <?= invalidFeedback('school_name') ? 'is-invalid' : ''; ?>" name="school_name" placeholder="SLB Negeri Cicendo Kota Bandung" value="<?= $generalSettings->school_name; ?>" required>
